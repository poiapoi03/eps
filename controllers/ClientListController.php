...
class ClientListController extends Controller
{
    ...
    public function actionClientUserAccess($id)
    {
        ...
        return $this->render('user_access', [
            'model' => $model,
    ...
    /**
     * Delete an existing ClientList model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ClientList model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = ClientList::findOne(['guid'=>$id])) !== null) {
            return $model;
        } else {
